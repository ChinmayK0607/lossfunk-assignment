...
Benchmarks CK0607/unsloth-trained-qwen-hard-rewards-250 with vLLM (not
Unsloth) on the first 100 reproducible samples (seed = 42) of
CK0607/jee-math-gsm8k and stores detailed results in a CSV.
